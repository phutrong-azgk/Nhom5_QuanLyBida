    ...
    public partial class ThemNhanVien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtMaNV.Text) || string.IsNullOrWhiteSpace(txtTenNV.Text) ||
                ...
                string.IsNullOrWhiteSpace(txtDiaChi.Text) || string.IsNullOrWhiteSpace(txtTenDangNhap.Text)) // Thêm kiểm tra txtTenDangNhap
            {
            ...
            TenDangNhap = txtTenDangNhap.Text.Trim(); // Gán giá trị mới
