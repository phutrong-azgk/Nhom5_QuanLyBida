...
{
    public partial class UserControl_Khach : System.Windows.Forms.UserControl
    {
        DataSet ds;
        ...
        private void UserControl_Khach_Load(object sender, EventArgs e)
        {
            LoadTablesFromDatabase();
        }
        ...
        private void btnSuaKhách_Click(object sender, EventArgs e)
        {
            foreach (Control c in flowLayoutPanelKhach.Controls)
            {
                if (c is Panel panel && panel.Tag is List<Button> list)
